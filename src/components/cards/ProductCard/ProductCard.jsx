...
export const ProductCard = ({ image, itemNo, title, price, isVeg, quantity }) => {
  return (
    <div className="bg-white h-[179px] w-[164px] relative rounded-[16px] shadow-[0px_4px_20px_0px_rgba(50,50,71,0.04),0px_0px_1px_0px_rgba(12,26,75,0.03)] flex-shrink-0">
